...
var element = document.getElementById("div1");--寻找网页中id񎎭iv1的元素
var child = document.getElementById("p1");--寻找网页中id为p1的元素
element.insertBefore(para, child);--将创建的标签添加򁼽iv1下的p1的前面
</script>
]]
...
<script>
var parent = document.getElementById("div1");--寻找id񎎭iv1的元素
var child = document.getElementById("p1");--寻找id为p1的元素
parent.removeChild(child);--񜁭iv1下的p1删除
</script>
]]
...
var parent = document.getElementById("div1");--寻找id񎎭iv1的标签
var child = document.getElementById("p1");--寻找id为p1的标签
parent.replaceChild(para, child);--񜁭iv1下的p1替换成新建的p标签
</script>
]]

查：
--[[
这里不做代码演示，将js的常用获񓵪pi一一列举
document.activeElement  --返回当前获取焦点元素
document.anchors  --返回对文档中所有 Anchor 对象的引用。
document.baseURI  --返回文档的绝对基础 URI
document.body  --返回文档񶡋ody元素
...
document.embeds  --返回文档中所有嵌入的内容󿂎mbed）集合
...
然后就可以使用jQuery库的语句了，下面简单说下它的增删改񧹚PI
增：
append和prepend方法：
...
删：
$("#div1").remove();  --删除ID񎎭iv1的元素
$("#div1").empty();  --删除ID񎎭iv1的子元素
